...
<br>
	...
	<h2>Edit Customer</h2></div>
	<form action='/customers/<?php echo $id; ?>/editsave/<?php echo $id; ?>' method="post" style="width:500px;font-weight:bold;margin-left:100px">
	<br>
	<p>
    <label>Customer_Name</label>
    <input class="w3-input" type="text" name="nameCus"  required></p>
    <p>
