...
<div class="w3-top">
  <div class="w3-bar w3-white w3-card" id="myNavbar"> 
    ...
    <a class="list-group-item w3-bar-item w3-button w3-wide w3-right" href="/managerCut"><i class="fa fa-arrow-circle-left"></i>BACK</a>
    </a>
  </div>
</div>
</head>
...
<form action='/employees/cuts' method="get">
<br>
