...
<body>
    ...
    <!-- Sidebar/menu -->
    <nav class="w3-sidebar w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;background:#00cc88"
        id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="/ordercloths/page/managerOrderCloth" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Current Work</a>
            <a href="/employees/page/managerOrderCloth" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Employees</a>
            <a href="/factors/page/managerOrderCloth" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Factories</a>
    ...
    <header class="w3-container w3-top w3-hide-large w3-xlarge w3-padding" style="background:#00cc88">
        <a href="javascript:void(0)" class="w3-button w3-margin-right" style="background:#006644" onclick="w3_open()">☰</a>
    ...
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
        ...
        <!-- Header -->
            ...
            <br>
            <br>
            <h1 class="w3-jumbo" style="margin-top:70px"><b>MANAGER ORDERCLOTH</b></h1>
