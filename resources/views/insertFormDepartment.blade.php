...
<h2>Insert Department</h2></div>
	<form action='/departments/save/<?php echo $page; ?>' method="post" style="width:500px;font-weight:bold;margin-left:100px">
    <br>
	<p>
        <label>Department Name</label>
        <input class="w3-input" type="text" name="departmentname" required>
    </p>
    <p>
