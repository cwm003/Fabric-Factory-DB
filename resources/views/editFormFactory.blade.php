...
<br>
	...
	<h2>Edit Factory</h2></div>
	<form action='/factors/<?php echo $id; ?>/editsave/<?php echo $page; ?>' method="post" style="width:500px;font-weight:bold;margin-left:100px">
    <br>
	<p>
    ...
    <input class="w3-input" type="text" name="name_factory" required></p>
    
    <!-- <p>
        <label>Factory ID</label>
        <label><input type="text" name="factory_id" 
        pattern="[0-9]{4}" 
        title="Four letter number code" required></label>
     -->
    <p>
        <label>Tel</label>
    ...
    <p>
        <label>Address</label>
       <input class="w3-input" type="text" name="address" required></p>
    
    <p>
        <label>Account</label>
        <input class="w3-input" type="text" name="account"
        pattern="[0-9]{10}" 
        title="Ten letter number account" ></p>
    <tr>
