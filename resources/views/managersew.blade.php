...
<body>
    ...
    <!-- Sidebar/menu -->
    <nav class="w3-sidebar w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;background:#ffff66"
        id="mySidebar"><br>
        ...
        <div class="w3-bar-block">
            ...
            <a href="/ordersews/page/managerSew" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Current Work</a>
            <a href="/employees/page/managerSew" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Employees</a>
    ...
    <header class="w3-container w3-top w3-hide-large w3-xlarge w3-padding" style="background:#ffff66">
        <a href="javascript:void(0)" class="w3-button w3-margin-right" style="background:#ffff00" onclick="w3_open()">☰</a>
    ...
    <div class="w3-main" style="margin-left:340px;margin-right:40px">
        ...
        <!-- Header -->
            <br>
            <br>
            <h1 class="w3-jumbo" style="margin-top:70px"><b>MANAGER SEWING</b></h1>
